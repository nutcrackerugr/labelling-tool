...
try:
    ...
    resampled = pd.read_csv("resampled.csv", index_col=0)
    todos_partido = pd.read_csv("todos_partido.csv", index_col=0)

    resampled2 = joblib.load("resampled.joblib.pkl")
    resampled2_neg = joblib.load("resampled_neg.joblib.pkl")
    resampled2_neu = joblib.load("resampled_neu.joblib.pkl")

except:
    todos = pd.read_csv("todos_sentiment_polar.csv", index_col=0)
    ...
    etiquetado = pd.read_csv("etiquetado.csv", dtype=dict(document_sentiment="str", PP="str", Cs="str", PSOE="str", UP="str", VOX="str",
    ...
    todos_partido.to_csv("todos_partido.csv")
    ...
    joblib.dump(resampled2, "resampled.joblib.pkl")
    joblib.dump(resampled2_neg, "resampled_neg.joblib.pkl")
    joblib.dump(resampled2_neu, "resampled_neu.joblib.pkl")
